...
var precisions = [10, 2, 5, 2, 10, 2, 5, 10, 5, 10, 5, 50, 10, 10, 10, 10, 10];
...
function getCandidateBreaks(lowerBreak, upperBreak, numBreaks) {
  ...
  var subRange =
    numBreaks >= 2 ? (upperBreak - lowerBreak) / (numBreaks - 1) : maxBreak;
...
function getBreakFenceposts(val, precision) {
  ...
  var fenceposts =
    boundVal < boundVal2 ? [boundVal, boundVal2] : [boundVal2, boundVal];
  return fenceposts;
}
