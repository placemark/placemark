...
GUI.canSaveToServer = function () {
  return (
    !!(mapshaper.manifest && mapshaper.manifest.allow_saving) &&
...
GUI.getInputElement = function () {
  ...
  return el && (el.tagName == "INPUT" || el.contentEditable == "true")
    ? el
    : null;
};
...
GUI.isReadableFileType = function (filename) {
  ...
  return (
    !!internal.guessInputFileType(filename) ||
    internal.couldBeDsvFile(filename) ||
