  ...
  if (q1 == 8 && q2 == 8) {
    ...
    if (q1 == 0) {
      ...
      if (q2 === 0 || q2 === 1 || q2 === 7) {
        ...
        if (!addSegmentBoundsIntersection(points, p1, p2, bbox) && closed)
        ...
        if (!addSegmentBoundsIntersection(points, p1, p2, bbox)) {
          ...
          if (
            geom.orient2D(p1[0], p1[1], p2[0], p2[1], bbox[0][0], bbox[0][1]) >
            1
          ) {
...
function addSegmentSegmentIntersection(points, a, b, c, d) {
  var p = geom.segmentIntersection(
    a[0],
    a[1],
    b[0],
    b[1],
