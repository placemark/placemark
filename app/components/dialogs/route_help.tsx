    ...
    <>
      ...
      <div>
        ...
        <p className="mt-2">
          ...
          waypoints and a linestring for the route. They are generated by the
          configured{" "}
          <a
            href="https://project-osrm.org/docs/v5.24.0/api/#route-service"
            className={styledInlineA}
          >
            OSRM-compatible routing service
          </a>
          . Routes are stored in the document, so the service must permit
          storing and exporting its results.
        </p>
        <p>
