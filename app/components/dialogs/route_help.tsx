    ...
    <>
      ...
      <div>
        ...
        <p className="mt-2">
          ...
          waypoints and a linestring for the route. They are generated by{" "}
          <a href={routingProvider?.homepage} className={styledInlineA}>
            {routingProvider?.name || "the configured routing provider"}
          </a>
          . Provider and attribution details are saved with the route so they
          remain available when the document is exported.
        </p>
        <p>
