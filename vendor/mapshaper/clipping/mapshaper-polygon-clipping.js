...
export function clipPolygons(targetShapes, clipShapes, nodes, type, optsArg) {
  ...
  var clippedShapes = targetShapes.map((shape, i) => {
    if (shape) {
  ...
  targetShapes.forEach((shape, shapeId) => {
