...
import {
  ...
  convertSimplifyInterval,
  convertSimplifyResolution,
  simplifyPaths,
  getStandardSimplifyOpts,
...
cmd.variableSimplify = function (layers, dataset, opts) {
  ...
  if (opts.interval) {
    getShapeThreshold = getVariableIntervalFunction(
      opts.interval,
      lyr,
      dataset,
      opts
    ...
    getShapeThreshold = getVariablePercentageFunction(
      opts.percentage,
      lyr,
      dataset,
      opts
    ...
    getShapeThreshold = getVariableResolutionFunction(
      opts.resolution,
      lyr,
      dataset,
      opts
