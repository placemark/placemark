...
function isReservedName(name) {
  return /^(stroke|stroke-width|stroke-dasharray|stroke-opacity|fill|fill-opacity|opacity|r|class)$/.test(
    name
  );
}
...
export function getColorizerFunction(opts) {
  ...
  if (opts.random) {
    ...
    colorFunction = getSequentialClassifier(
      opts.breaks,
      opts.colors,
      nodataColor,
      round
